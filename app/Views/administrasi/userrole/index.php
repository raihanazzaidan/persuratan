    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3><?= $title; ?></h3>
                <a href='<?= base_url('administrasi/role/adduserrole'); ?>' class="btn btn-primary">Tambah User Role</a>
            </div>
                    ...
                    <tbody>
                        ...
                        foreach ($userrole as $usrl => $userrole) { ?>
                            <tr>
                                ...
                                <td>
                                    <a href='<?= base_url('/administrasi/role/edituserrole/' . $userrole->id); ?>' class="btn btn-primary">
                                    <i class="bi bi-pencil-square"></i> Edit</a>
                                    <a href='<?= base_url('/administrasi/role/hapususerrole/' . $userrole->id); ?>' class="btn btn-danger">
