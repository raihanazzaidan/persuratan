...
<section class="section">
    <div class="card">
        ...
        <div class="card-body">
            <form action="<?= base_url('administrasi/jabatan/addjabatan/prosesaddjabatan'); ?>" enctype="multipart/form-data" method="post">
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <select name="subsatker_id" class="form-select">
                                ...
                                <?php foreach ($s as $value => $s) { ?>
                                    <option value="<?= $s->id ?>"><?= $s->nama_subsatker; ?></option>
                                <?php } ?>
                            </select>
                        </div>
                    </div>
