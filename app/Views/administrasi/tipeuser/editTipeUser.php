<?php foreach ($getTipeUser as $data) { ?>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <form action="<?= base_url('administrasi/tipe-user/edittipeuser/prosesedittipeuser/' . $data->id); ?>" enctype="multipart/form-data" method="post">
                    <div class="row">
                        <div class="col-md-6">
